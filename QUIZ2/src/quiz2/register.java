...
public class register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Masukan Password ");
        jPanel2.add(jLabel6);

        tfPassword1.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jPanel2.add(tfPassword1);
        ...
        jLabel4.setText("Suda punya akun?");
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            String sql="insert into login values('"+ tfUser.getText()+"',"
                    + "'"+ tfPassword.getText()+"')";
